The code simulates dynamics of Nc = 32 cells on a degrading substrate with durotaxis. The code derived from the research work "Durotaxis and extracellular matrix degradation 
